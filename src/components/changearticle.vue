<template>
  <div class="changearticle">
    <div class="changearticle_title">
      <span>文章</span>
      <span class="title_sep">/</span>
      <span>修改文章</span>
      <div class="title_back" @click="back">返回</div>
    </div>
    <div class="changearticle_content">
